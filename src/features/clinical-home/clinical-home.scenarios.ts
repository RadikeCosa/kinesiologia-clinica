...
const patients: HomePatientViewModel[] = [
  { id: "elena", displayName: "Elena Ficticia", phone: "+54 299 000 0101", address: "Calle Demostración 101, Neuquén", treatment: { status: "active", completedSessions: 4, totalSessions: 10, frequency: "2 veces por semana", nextVisitLabel: "Hoy · 08:00" } },
  { id: "martin", displayName: "Martín Ejemplo", phone: "+54 299 000 0102", address: "Calle Ficticia 456, Neuquén", treatment: { status: "active", completedSessions: 6, totalSessions: 10, frequency: "2 veces por semana", nextVisitLabel: "Hoy · 09:30" } },
  { id: "rosa", displayName: "Rosa Demostración", phone: "+54 299 000 0103", address: "Avenida de Prueba 123, Neuquén", accessInstructions: "El timbre no funciona. Avisar por teléfono al llegar.", precautions: ["Riesgo de caída", "Utiliza andador"], lastVisitLabel: "12 de septiembre", latestPlan: "Continuar entrenamiento de marcha dentro del domicilio y reforzar transferencia sentado-de-pie.", treatment: { status: "active", completedSessions: 7, totalSessions: 10, frequency: "Martes y viernes", nextVisitLabel: "Hoy · 11:00" } },
  { id: "carlos", displayName: "Carlos Ficticio", phone: "+54 299 000 0104", address: "Pasaje de Ensayo 50, Neuquén", treatment: { status: "active", completedSessions: 9, totalSessions: 10, frequency: "1 vez por semana", nextVisitLabel: "Hoy · 15:00" } },
  { id: "ana", displayName: "Ana Ejemplo", phone: "+54 299 000 0105", address: "Calle de Muestra 80, Neuquén", treatment: { status: "active", completedSessions: 2, totalSessions: 10, frequency: "2 veces por semana", nextVisitLabel: "Hoy · Sin horario" } },
